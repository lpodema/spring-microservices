...
package com.educacionit.services.employee;
...
import com.educacionit.services.employee.model.Employee;
import com.educacionit.services.employee.repository.EmployeeRepository;
...
public class EmployeeApplication {
	...
	public Docket swaggerPersonApi10() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("com.educacionit.services.employee.controller"))
